...
##
##    Post-condition: Gives first step of speech lesson
##-----------------------------------------------------------------------------------------
def step1():
...
##    Pre-condition: Function is called
##
##    Post-condition: Gives second step of speech lesson
##-----------------------------------------------------------------------------------------
def step2():
    ...
    lecture = ["Next, we must declare an object using the modules we just imported",
               ...
               "Since we're trying to code speech, we're going to use the a l text to speech module",
    ...
    for x in range(len(lecture)):
        ...
        if(x == 3): print "'objectname' = ALProxy(''ALTextToSpeech'', 'IP Address', 9559)"
        tts.say("\\pau=700\\" + lecture[x])
...
##    Pre-condition: Function is called
##
##    Post-condition: Gives third step of speech lesson
##-----------------------------------------------------------------------------------------
def step3():
    
    ##List of instructional lecture
    lecture = ["Finally, all we need to do now is have our object call a method",
               "Have your a l proxy object call the say method using the syntax shown on your terminal",
               "For your parameter, write anything you'd like your robot to say",
               "Remember to keep your parameter within double quotation marks",
               "Once you're finished with that, save your file",
               "With only three lines of code, you have all the basic tools you need to code speech",
               "If you run your python script, your robot should say whatever you wrote"]
    ...
    for x in range(len(lecture)):
        ...
        #Read line from speech
        if(x == 1): print "'objectname'.say(''parameter'')"
        tts.say("\\pau=700\\" + lecture[x])
